                                ...
                                <div className="flex flex-wrap gap-1.5 pt-2">
                                    {item.params && (
                                        <>
                                            ...
                                            {item.params.useCrt && (
                                                <span className="px-1.5 py-0.5 rounded bg-emerald-50 dark:bg-emerald-900/20 text-[9px] font-medium text-emerald-600 dark:text-emerald-400 border border-emerald-100 dark:border-emerald-800/50">
                                                    CRT
                                                </span>
                                            )}
